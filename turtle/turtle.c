...
struct prog{
    ...
    #ifdef INTERPRETER /* variables for sdl */
...
void test(void)
{
    ...
    /* First part of code */
    /* checking Change and Movement works as intended */
    Main(p);
    ...
    /* Second part of code */
    /* checking DO statement works as intended */
    p->cw++;
    p->curcoord.x = 0;
    p->curcoord.y = 0;
    p->curcoord.angle = 0;
    ...
    /* Third part of code */
    /* checking nested DO loops works as intended */
    p->cw++;
    p->curcoord.x = 0;
    p->curcoord.y = 0;
    p->curcoord.angle = 0;
    ...
    /* Fourth part of code */
    /* checking SET works to set a variable */
    p->cw++;
    p->curcoord.x = 0;
    p->curcoord.y = 0;
    p->curcoord.angle = 0;
    ...
    /* Fifth part of code */
    /* checking polish expression is evalutated correctly */
    p->cw++;
    p->curcoord.x = 0;
    p->curcoord.y = 0;
    p->curcoord.angle = 0;
    ...
    /* Sixth part of code */
    /* checking varnum returns the correct value from a variable */
    p->cw++;
    p->curcoord.x = 0;
    p->curcoord.y = 0;
    p->curcoord.angle = 0;
